    ...
    return (
      <Segment>
        ...
        <Grid>
          <Grid.Row />
          <Grid.Column width={4}>
            <Header color="teal" sub content="Βήμα 1 - Πρόσθεσε φωτογραφία" />
            <Dropzone onDrop={this.onDrop} multiple={false}>
              <div style={{ paddingTop: '30px', textAlign: 'center' }}>
                <Icon name="upload" size="huge" />
                <Header content="Κλίκαρε στο upload ή κάνε drag'n'drop" />
              </div>
            </Dropzone>
          </Grid.Column>
          <Grid.Column width={1} />
          <Grid.Column width={4}>
            <Header sub color="teal" content="Βήμα 2 - Περικοπή της εικόνας" />
            {this.state.files[0] && (
              <Cropper
          ...
          <Grid.Column width={1} />
          <Grid.Column width={4}>
            <Header sub color="teal" content="Βήμα 3 - Προβολή και ανέβασμα" />
            {this.state.files[0] && (
              <div>
                <Image
        ...
        <Divider />
        <Header sub color="teal" content="Όλες οι φωτογραφίες μου" />

        <Card.Group itemsPerRow={5}>
          <Card>
            <Image src={profile.photoURL || '/assets/user.png'} />
            <Button positive>Κεντρική φωτογραφία</Button>
          </Card>
          {photos &&
